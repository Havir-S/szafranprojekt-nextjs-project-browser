...
function NewNote({toggleNewNote}) {
  ...
  return (
    <div className='p-5 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-2/4 z-10 rounded-lg shadow-lg  border-2 bg-gray-100 border-green-500'>
